...
(function () {
  ...
  var versions = ["main","async-tasks","bug-msvs-20220928","dependabot/github_actions/jakoch/install-vulkan-sdk-action-1.1.1","int128","label-delegate","modules-part1","msvc-bug-20221214","msvc-bug-20230706","msvc-c1001-20231106","msvs-bug-20230428","msvs-bug-20230503","msvs-bug-20230517","new-window-widget","phrase-mask-chars","ranged-int","release-0.8.2","style-set-name","text","0.8.1","0.8.0","0.7.0","0.6.0","0.5.1","0.5.0","0.4.0","0.3.0","0.2.3","0.2.2","0.2.1","0.2.0","0.1.0"];
